...
var xm = avalon.define({
  ...
  created: function created() {
    ...
    $.ajax({
      ...
      success: function success(res) {
        // 统计记录数
        _this15.totalNums.plugin = res.data.plugin.num;
        _this15.totalNums.music_1 = res.data.music.sort[0].num;
        _this15.totalNums.music_2 = res.data.music.sort[1].num;
        _this15.totalNums.music_3 = res.data.music.sort[2].num;
        _this15.plugList = res.data.plugin.list;
