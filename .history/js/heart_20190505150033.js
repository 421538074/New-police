...
var xm = avalon.define({
  ...
  allPlayIE:function allPlayIE() {
    // $('body embed').remove();
    // var str = '<embed id="player-ie" mastersound preload controls width="300" height="100" src="musci/玄觞、双笙 - 千梦.mp3"></embed>';
    // $('body').append(str);
    // $('body').append('<span>测试元素</span>');
    // var emPlayer = document.getElementById('player-ie');
    // console.log(emPlayer);
    // var emPlayer = document.createElement('embed');
    // emPlayer.src = 'musci/啊啊啊.mp3';
    // document.body.appendChild(emPlayer);
    // emPlayer.play();

    var player = document.createElement('embed');
				player.src = 'music/啊啊啊.mp3';
