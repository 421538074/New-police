...
var indexPage = {
  name: 'cp-page',
  template: "\n    <nav>\n    <ul class=\"pagination\">\n      <li class=\"one\" ms-class=\"{'disabled': current == 1}\"><a href=\"javascript:;\" ms-click=\"setCurrent(current - 1)\">\u4E0A\u4E00\u9875</a></li>\n    \n      <li ms-for=\"p in grouplist\" ms-class=\"{'active': current == p.val}\" >\n         <span class=\"page_test\" ms-click=\"setCurrent(p.val)\">{{ p.text }}</span>   \n      </li>\n   \n      <li class=\"one\" ms-class=\"{'disabled': current == page}\"><a href=\"javascript:;\" ms-click=\"setCurrent(current + 1)\">\u4E0B\u4E00\u9875</a></li>\n    </ul>\n  </nav>\n    ",
  defaults:{
